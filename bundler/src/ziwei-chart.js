// 星途羅盤紫微圖表 Custom Element v2.0.0
// 打包入口文件 - 解決 IZTRO 命盤顯示結構錯誤問題
...
window.ReactIztro = ReactIztro;

console.log('🎯 Dependencies loaded:', {
    React: !!React,
    ReactDOM: !!ReactDOM,
    ReactIztro: !!ReactIztro,
    Iztrolabe: !!ReactIztro.Iztrolabe
});
...
class ZiweiChartElement extends HTMLElement {
    ...
    async _ensureDependencies() {
        ...
        while (waitTime < maxWaitTime) {
            if (window.React && window.ReactDOM && window.ReactIztro && window.ReactIztro.Iztrolabe) {
...
console.log('🚀 Ziwei Chart Bundle v2.0.0 loaded successfully'); 