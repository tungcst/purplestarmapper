// 星途羅盤紫微圖表 Custom Element v2.1.0
// 使用外部 React 依賴 - 修正與 Wix 系統的衝突問題

// 引入只包含 react-iztro，不包含 React
import * as ReactIztro from 'react-iztro';

console.log('🎯 ZiweiChart v2.1.0 - External React Mode');

// 檢查 Wix 系統的 React 依賴
function checkExternalReact() {
    console.log('🔍 Checking for external React dependencies...');
...
// Enhanced Ziwei Chart Custom Element (使用外部 React)
class ZiweiChartElement extends HTMLElement {
    ...
    constructor() {
        ...
        console.log('🎯 ZiweiChartElement initialized (External React mode)');
    }
    ...
    _renderChart() {
        ...
        try {
            ...
            console.log('🎯 Rendering chart with props:', iztroProps);
...
if (!customElements.get('ziwei-chart')) {
    ...
    console.log('🎯 ZiweiChartElement registered successfully (External React mode)');
} else {
...
console.log('🚀 Ziwei Chart Bundle v2.1.0 loaded (External React Mode)');
console.log('🔗 Using external React from Wix system'); 